...
D = 4.28           # 실효 공백 (s)
RHO = 0.50         # 가동률
RHO_D = 0.5134     # λ/μ_d — 기준 arm(200k·ρ0.50·빠른 저장소 밴드)의 장애 run 6개
                   # 중앙값 λ=54811, μ_d=106761에서 측정. 2026-09-13 정정:
                   # 이전 값 0.5563은 Table IV의 τ*와 맞도록 역산한 것이었음.
DELTA_CAP = 0.22   # 용량 기준 체크포인트 비용 (s), 본문 0.15–0.22 범위의 상한.
                   # Figure 4 캡션에 명시할 것.
